        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="list_status_products.php" class="btn btn-primary">Trở lại</a> <!-- Corrected link -->
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
        ...
        <form action="edit_status_products.php" method="POST">
            <div class="container-fluid">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="status_products_name" id="status_products_name" class="form-control"
                                        placeholder="Tên" value="<?php echo $categories['status_products_name'] ?>">
                ...
                <div class="pb-5 pt-3">
                    ...
                    <a href="list_status_products.php" class="btn btn-primary">Hủy</a>
                </div>
            </div>
        </form>
        <!-- /.card -->

        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="create_status_products.php" class="btn btn-primary"><i class="fa-solid fa-plus"></i></a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="mx-2" style="border-right: 1px solid #000 hover"  href="edit_status_products.php?status_products_id=<?php echo $status_products['status_products_id'] ?>">

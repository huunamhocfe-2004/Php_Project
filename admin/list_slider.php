        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="create_slider.php" class="btn btn-primary"><i class="fa-solid fa-plus"></i></a>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <table class="table table-hover text-nowrap">
                        <thead>
                            <tr>
                                ...
                                <th width="500">Ảnh trình chiếu</th> 
                                <th width="10">Tên</th>
                        ...
                        <?php 
                            ...
                            ?>
                                ...
                                <?php endwhile; ?>
                            <?php else: ?>
                                <tr><td colspan="7">Không có ảnh trình chiếu.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
